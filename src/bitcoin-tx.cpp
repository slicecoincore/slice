...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " slice-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  slice-tx [options] <hex-tx> [commands]  Update hex-encoded slice transaction\n" +
            "or:     slice-tx [options] -create [commands]   Create hex-encoded slice transaction\n" +
            "\n";
