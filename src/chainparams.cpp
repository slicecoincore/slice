...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x8e80e8a61c0e69794956aaddc330f47f564b9ed5e058ddeefcc9ba5debcd77d9");
        consensus.BIP65Height = 10;
        consensus.BIP66Height = 10;
        consensus.CSVHeight = 24192;
        consensus.SegwitHeight = 24192;
        consensus.MinBIP9WarningHeight = 32256; // segwit activation height + miner confirmation window
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000001e060cc8b512aea3");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x5d6743a8a0d53b7df64395e78f384f2958231af0073364d572ff1110e53e8460"); // 597379
        ...
        checkpointData = {
            {
                ...
                { 98500, uint256S("0x5d6743a8a0d53b7df64395e78f384f2958231af0073364d572ff1110e53e8460")},
            }
        };

        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 5d6743a8a0d53b7df64395e78f384f2958231af0073364d572ff1110e53e8460
            /* nTime    */ 1583728961,
            /* nTxCount */ 153477,
            /* dTxRate  */ 0.004215929151028763,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        consensus.BIP65Height = 10;
        consensus.BIP66Height = 10;
        consensus.CSVHeight = 8064;
        consensus.SegwitHeight = 8064;
        consensus.MinBIP9WarningHeight = 16128; // segwit activation height + miner confirmation window
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 6 * 60;
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00"); // 1580000
