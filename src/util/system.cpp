...
const char * const BITCOIN_CONF_FILENAME = "slice.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Slice";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Slice";
#else
    // Unix
    return pathRet / ".slice";
#endif
#endif
}
