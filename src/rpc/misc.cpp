    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given slice address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The slice address to validate"},
                },
                RPCResult{
            "{\n"
            ...
            "}\n"
                ...
                RPCExamples{
                    HelpExampleCli("validateaddress", "\"sNe95m1iJsyyTyBvXgti3T8h5mkydYdVBj\"")
            + HelpExampleRpc("validateaddress", "\"sNe95m1iJsyyTyBvXgti3T8h5mkydYdVBj\"")
                },
            }.ToString());
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The slice address to use for the signature."},
            ...
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("verifymessage", "\"sNe95m1iJsyyTyBvXgti3T8h5mkydYdVBj\", \"signature\", \"my message\"")
                },
            }.ToString());
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "slice-cli and the GUI. There is no server-side difference.",
                {},
                RPCResults{},
                RPCExamples{""},
            }.ToString()
